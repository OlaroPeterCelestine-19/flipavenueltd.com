...
switch(DB_URL){
	case 'localhost':
		...
		defined ("DB_NAME") or define("DB_NAME", "flipavenueltd");
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/flipavenueltd.com');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/flipavenueltd.com/users');
	break;

	case 'https://www.flipavenueltd.com': 
		defined ("DB_SERVER") or define("DB_SERVER", 'localhost');
		...
		defined ("SITE_URL") or define("SITE_URL", "https://flipavenueltd.com");
		defined ("HOME_URL") or define("HOME_URL", "https://flipavenueltd.com/users");
	break;
