	...
	<div class="product">
		...
		<div class="product_content">
			<div class="product_info d-flex flex-row align-items-start justify-content-start">
				<div>
					<div>
						<div class="product_name"><a href="product?i=<?=base64_encode($rx->pid);?>&pname=<?=$rx->pname; ?>"><?=$rx->pname; ?></a></div>
						<div class=""><a class="btn btn-success" href="product?i=<?=base64_encode($rx->pid);?>&pname=<?=$rx->pname; ?>">Order Now</a></div> 
					</div>
				</div>
				<div class="ml-auto text-right">
					<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
					<div class="product_price text-right"><span>Ugx</span> <span><?=number_format($rx->pprice,2); ?></span></div>
				</div>
			</div>
			<div class="product_buttons">
				<div class="text-right d-flex flex-row align-items-start justify-content-start">
